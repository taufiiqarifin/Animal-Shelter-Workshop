...
<!-- Page Header -->
<div class="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-11">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('animal-management.index') }}"
                   class="inline-flex items-center justify-center bg-purple-900/80 hover:bg-purple-900 text-white p-3 rounded-full transition duration-300 shadow-md">
