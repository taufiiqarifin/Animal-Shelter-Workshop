...
<!-- Page Header -->
<div class="bg-gradient-to-r from-purple-600 to-purple-800 py-11">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">

        <!-- Left: Title -->
        <div>
            <h1 class="text-3xl font-bold mb-2 text-gray-100">
                Our Animals
            </h1>

            <p class="text-purple-200">
                Hello , Future Pawrtner! See who would you like to adopt.
            </p>
        </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    @else
        <div class="bg-white rounded-lg shadow p-12 text-center">
            ...
            <p class="text-gray-600 mb-6">Almost there! Please try broadening your preferences..</p>
