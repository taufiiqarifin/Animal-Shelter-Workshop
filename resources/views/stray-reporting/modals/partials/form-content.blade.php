...
<div class="col-span-9" id="successModalBody">
    ...
    <div id="validationAlert" class="hidden mb-6 flex items-start gap-3 p-4 bg-red-50 border-2 border-red-300 rounded-xl shadow-sm">
        ...
        <div class="flex-1">
            <p class="font-bold text-red-800 mb-1">Validation Error</p>
            <p id="validationMessage" class="text-sm text-red-700"></p>
        </div>
        <button onclick="hideValidationAlert()" class="text-red-600 hover:text-red-800 transition">
